...
CREATE INDEX weather_station_location_ix ON weather_station( ST_DistanceSphere( ST_SetSRID( ST_Point(longitude, latitude), 4326), ST_MakePoint(-97.0970, 33.0146)));
